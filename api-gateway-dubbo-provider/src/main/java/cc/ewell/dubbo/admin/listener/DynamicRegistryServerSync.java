 ...
 */
package cc.ewell.dubbo.admin.listener;

import cc.ewell.dubbo.admin.common.util.CoderUtil;
...
/**
 * @author xushiling
 * @description 动态切换注册中心监听器
 * @createDate 2022/3/11 10:37 上午
 */
@Component
public class DynamicRegistryServerSync implements DisposableBean, NotifyListener {

    private static final Logger logger = LoggerFactory.getLogger(DynamicRegistryServerSync.class);
...
//    @Autowired
    ...
    public void startSubscribe(String registryAddress) {
