...
import cc.ewell.dubbo.admin.model.dto.BaseDTO;
...
import static cc.ewell.dubbo.admin.common.util.Constants.COLON;
...
public class ConvertUtil {
    ...
    public static String getScopeFromDTO(BaseDTO baseDTO) {
        if (StringUtils.isNotEmpty(baseDTO.getApplication())) {
            return cc.ewell.dubbo.admin.common.util.Constants.APPLICATION;
        } else {
            return cc.ewell.dubbo.admin.common.util.Constants.SERVICE;
        }
    }
