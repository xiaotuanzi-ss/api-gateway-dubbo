...
package cc.ewell.dubbo.admin.registry.metadata.impl;
...
public class ZookeeperMetaDataCollector implements MetaDataCollector {
    ...
    private String doGetMetadata(MetadataIdentifier identifier) {
        ...
        try {
            ...
            // /dubbo/metadata/org.apache.dubbo.cc.ewell.dubbo.admin.api.NoResponse2Service/1.0.0/test/provider/dubbo-org.apache.dubbo.admin-integration-provider
            //"2.7.0" 元数据路径后加 /service.data
//            if ("2.7.0".equals(release)){
